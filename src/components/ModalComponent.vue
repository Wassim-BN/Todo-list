...
<template>
  <div v-if="todosStore.isOpen" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-xl h-50 bg-blue-500 rounded shadow z-99">
    <div class="flex justify-center items-center">
      <span class="p-2 font-size-xl">Todo Text</span>
    </div>
    <div class="flex justify-center items-center p-4 gap-4">
      ...
      <div class="flex justify-center items-center gap-4 bg-sky-200 rounded px-2 py-1">
    ...
    <div class="flex justify-center p-4 gap-4">
      <button 
        class="items-center text-white px-2 py-1 cursor-pointer rounded transition duration-150 ease-in-out" 
        @click="handleSubmit" 
      ...
      <button class="items-center px-2 py-1 cursor-pointer rounded bg-gray-300 hover:bg-gray-400 transition duration-300 ease-in-out" @click="closeModal">
        Fermer
      </button>
    </div>
  </div>
